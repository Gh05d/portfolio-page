export const portfolioItems = [
  {
    ...
    title: "Tribute Page",
    description: "A Tribute Page for Richard Feynman",
  ...
  },
  {
    ...
    title: "Partytube",
    description:
      "A simple site which takes content from youtube and makes searching for several videos in the same page possible",
  ...
  },
  {
    ...
    description:
      "A page which fetches Quotes from Donald Trump from an external API",
  ...
  },
  {
    ...
    description:
      "An app which fetches data from wikipedia in realtime as soon as the user enters a searchterm",
    technologies: ["HTML", "CSS", "Bootstrap", "React", "Axios"]
  },
  {
    ...
    description:
      "This app shows some channels from Twitch.tv and let's you filter them if they're on- or offline",
  ...
  },
  {
    ...
    description:
      "A Tic Tac Toe Game with an Implementation of the MiniMax-Algorithm",
  ...
  },
  {
    ...
    description:
      "A simple App to which shows you a preview of a text using markup from github. Integrates the marked library",
  ...
  },
  {
    ...
    description:
      "An app which shows the current ranking of people posting on the gitter channel of freeCodeCamp",
